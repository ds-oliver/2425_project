...
def transform_shot_data(df_shots):
    ...
    grouped_df_shots_team = (
        df_shots.groupby("team")
        .agg(
            {
                "shots": "sum",
                "xg": "sum",
    ...
    with tab3:
        ...
        with st.container(border=True):
            ...
            styled_df_players_matches = (
                ...
                .highlight_max(
                    subset=numerical_columns_matches,
                    props="color:crimson; font-weight:bold; background-color:#030021;",
                )
                .highlight_min(
                    subset=numerical_columns_matches,
            ...
            styled_df_players_summary = (
                ...
                .highlight_max(
                    subset=numerical_columns_summary,
                    props="color:crimson; font-weight:bold; background-color:#030021;",
                )
                .highlight_min(
                    subset=numerical_columns_summary,
